...
@interface ImformationManager ()
@property(nonatomic,strong)NSMutableArray *modelArr;
@end
@implementation ImformationManager
...
{
    static ImformationManager *manager = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        manager =[[ImformationManager alloc]init];
    });
    return manager;
}
@end
